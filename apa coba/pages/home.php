...
<body>
  <div class="dashboard-container">
    <header class="dashboard-header">
      ...
      <div class="welcome-message" style="margin-left: 20px; color: #4CAF50;">
      </div>
      ...
      <div class="user-menu">
        <a href="unggah-barang.html" class="upload-btn"><i class="fas fa-plus"></i> <span>Pasang Barang</span></a>
        <a href="notifikasi.html" class="notification-btn"><i class="fas fa-bell"></i></a>
        <div class="user-dropdown">
          <img src="../assets/image/adit.jpg" alt="User Avatar" class="user-avatar">
          <div class="dropdown-content">
            <a href="profil.html"><i class="fas fa-user"></i><?php echo htmlspecialchars($username); ?></a>
            <a href="barang-saya.html"><i class="fas fa-box"></i> Barang Saya</a>
